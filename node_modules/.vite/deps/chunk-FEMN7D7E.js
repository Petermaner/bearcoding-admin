...
var CloseCircleFilled_default2 = React4.forwardRef(CloseCircleFilled);
...
var useLocale = (componentName, defaultLocale) => {
  const fullLocale = React5.useContext(context_default);
  const getLocale = React5.useMemo(() => {
    var _a;
  ...
  const getLocaleCode = React5.useMemo(() => {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React6.useMemo(() => Object.assign(Object.assign({}, locale4), {
    exist: true
  }), [locale4]);
...
var style_default2 = genComponentStyleHook("Space", (token) => [genSpaceStyle(token), compact_default(token)], () => ({}), {
...
var SpaceCompactItemContext = React13.createContext(null);
var useCompactItemContext = (prefixCls, direction) => {
  const compactItemContext = React13.useContext(SpaceCompactItemContext);
  const compactItemClassnames = React13.useMemo(() => {
...
var NoCompactStyle = (_ref) => {
  ...
  return React13.createElement(SpaceCompactItemContext.Provider, {
    value: null
  }, children);
};
var CompactItem = (_a) => {
...
var Compact = (props) => {
  ...
  const nodes = React13.useMemo(() => childNodes.map((child, i) => {
    const key = child && child.key || `${prefixCls}-item-${i}`;
    return React13.createElement(CompactItem, {
      key,
  ...
  return wrapSSR(React13.createElement("div", Object.assign({
    className: clx
  }, restProps), nodes));
};
...
var genStatusStyle = (token, parentCls) => {
  ...
  return {
    [`&-status-error:not(${parentCls}-disabled):not(${parentCls}-borderless)${parentCls}`]: {
      ...
      "&:focus, &-focused": Object.assign({}, genActiveStyle(merge2(token, {
...
var Input = (0, import_react9.forwardRef)((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    bordered = true,
    status: customStatus,
  ...
  return wrapSSR(import_react9.default.createElement(es_default, Object.assign({
    ...
    className: (0, import_classnames4.default)(className, rootClassName, compactItemClassnames),
...
var TextArea = (0, import_react10.forwardRef)((_a, ref) => {
  var {
    prefixCls: customizePrefixCls,
    bordered = true,
    size: customizeSize,
  ...
  const disabled = React15.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
    feedbackIcon
  } = React15.useContext(FormItemInputContext);
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  ...
  if (typeof allowClear === "object" && (allowClear === null || allowClear === void 0 ? void 0 : allowClear.clearIcon)) {
    ...
    mergedAllowClear = {
      clearIcon: React15.createElement(CloseCircleFilled_default2, null)
    };
  }
  const [wrapSSR, hashId] = style_default3(prefixCls);
  return wrapSSR(React15.createElement(es_default2, Object.assign({}, rest, {
    disabled: mergedDisabled,
    allowClear: mergedAllowClear,
    classes: {
    ...
    prefixCls,
    suffix: hasFeedback && React15.createElement("span", {
...
//# sourceMappingURL=chunk-FEMN7D7E.js.map
